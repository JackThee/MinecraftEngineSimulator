...
import net.mcreator.mse.init.MseModTabs;
import net.mcreator.mse.init.MseModSounds;
import net.mcreator.mse.init.MseModMenus;
...
@Mod("mse")
public class MseMod {
	public static final Logger LOGGER = LogManager.getLogger(MseMod.class);
	public static final String MODID = "mse";

	public MseMod(IEventBus modEventBus) {
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		MseModSounds.REGISTRY.register(modEventBus);
		MseModBlocks.REGISTRY.register(modEventBus);
		MseModBlockEntities.REGISTRY.register(modEventBus);
		MseModItems.register(modEventBus);

		MseModTabs.REGISTRY.register(modEventBus);

		MseModMenus.REGISTRY.register(modEventBus);

		MseModFluids.REGISTRY.register(modEventBus);
		MseModFluidTypes.REGISTRY.register(modEventBus);
